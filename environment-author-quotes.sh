...
export CONFIG_SCHEMA_PATH="../../config-author-quotes-1.json"

export SQL_DB_USERNAME="root"
export SQL_DB_PASSWORD="eagle1"
export SQL_DB_DATABASE="author_quotes"

export ADMIN_USERNAME="admin"
export ADMIN_PASSWORD="BjPBdMnC5qd2j55C"
export ADMIN_SESSION_EXPIRY_IN_SECONDS=2592000

export SECRET_KEY="/B?E(H+MbQeThWmZq3t6w9z&F)J@Nc"

export LOADER_TIMER_INTERVAL_SECONDS=0
